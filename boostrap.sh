...
personal () {
  ...
  # telegram
  echo "deb http://ppa.launchpad.net/noobslab/apps/ubuntu trusty main" >> /etc/apt/sources.list
  echo "deb-src http://ppa.launchpad.net/noobslab/apps/ubuntu trusty main" >> /etc/apt/sources.list
